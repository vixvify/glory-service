        ...
        ? member.movies.map((mc) => ({
            ...
            movie: mc.movie
              ? {
                  ...
                  ageRating: mc.movie.ageRating.name,
                  duration: mc.movie.duration,
                  university: mc.movie.university?.name || null,
                  school: mc.movie.school?.name || null,
                  language: mc.movie.language?.name || null,
                  subtitle: mc.movie.subtitle?.name || null,
                  contentWarnings: (mc.movie.contentWarnings || []).map((cw) => cw.name),
                  otherContentWarning: mc.movie.otherContentWarning,
                  tags: (mc.movie.tags || []).map((t) => t.name),
                  colorType: mc.movie.colorType.name,
