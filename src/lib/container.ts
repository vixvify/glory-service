...
import { WatchSessionRepositoryImpl } from "../infrastructure/watch-session.repository";
...
import { WatchSessionService } from "../modules/watch-sessions/service";
...
export const watchSessionRepo = new WatchSessionRepositoryImpl();
...
export const watchSessionService = new WatchSessionService(watchSessionRepo, movieRepo);
